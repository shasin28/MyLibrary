...
public class LibPresentationImpl implements LibPresentation {
	...
	public void performMenuAdmin(int choice) {
		...
		case 2:
			...
			if (students.size() == 0)
				System.out.println(
						"Poor library!!! waitng for students to register ; no students registered at present here");
			else {
	...
	public void performMenuStudent(int choice) {
		...
		case 1:
			...
			try {
				...
				System.out.println(
						"Meditate a bit and put your student id more carefully; better luck ! Found Illegal student id format");
			} catch (StudentIdNotFoundException e) {
