...
public class LibMain {
	...
	public static void main(String[] args) {
		...
		if(user.equals("admin"))
		{
			...
			{   chances--;
			if(chances!=0)
				System.out.println("Not the correct password!Try again "+ chances+" left for giving correct password!");
			else
				System.out.println("OOps ! seems you forgot your password-- have a cup of coffee and try again later");
				scanner.next();
			}
		}
		}
