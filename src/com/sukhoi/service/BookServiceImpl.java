...
public class BookServiceImpl implements BookService {
	...
	//HashMap<String,Integer> fineAmount=new HashMap<>();
	...
	public boolean removeBook(int bId) throws BookNotFoundException, IssuedBookDeletionException {
			...
			if( bookDao.deleteBook(bId)==true)
			{
	        	...
	        	{
	        		throw new IssuedBookDeletionException("This book at present is issued to a geek! with student id "+book.getStudentId()+" first get it back!! can't remove book before that ");
	        	}
	...
	public void fineOnABook(Book currBook) {
	   ...
	   // long numDays=30;
		...
		//Period difference=Period.between((currBook.getIssueDate(),currBook.getReturnDate());
		//int numDays=dayBetween(currBook.getIssueDate(),currBook.getReturnDate());
